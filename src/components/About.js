...
export default function About(props) {
  ...
  return (
    <div className="container" style={{backgroundColor:props.mode==='dark'?"#042743":"white",color:props.mode==='dark'?"white":"black"}}>
      ...
      <div className="accordion" id="accordionExample" style={{backgroundColor:props.mode==='dark'?"#042743":"white"}}>
  <div className="accordion-item" style={{backgroungColor:props.mode==='dark'?"#042743":"white"}}>
  ...
  <div className="accordion-item" style={{backgroundColor:props.mode==='dark'?"#042743":"white"}}>
    ...
    <div id="collapseThree" className="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
      <div className="accordion-body" style={{backgroungColor:props.mode==='dark'?"#042743":"white",color:props.mode==='dark'?"white":"black"}}>
